...
namespace ContentMetadataApi_Tests
{
    ...
    class GetContentsByOwnerIdCommand_Should : public ::testing::Test
    {
    protected:
        ...
        void SetUp() override
        {
            ...
            m_owner_id = boost::uuids::random_generator()();

            m_sut = std::make_unique<ContentMetadataApi::Routing::GetContentsByOwnerIdCommand>(
                m_owner_id, m_mock_contract, m_mock_mapper, m_mock_visitor_factory);
        }
    };
}
